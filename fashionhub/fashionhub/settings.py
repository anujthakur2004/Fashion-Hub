...
SECRET_KEY = 'django-insecure-uo&mk73u#kuj(4+=-+xwu6mwtcm=05-6@a=uhy+9w40!i0q--r'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['anujthakur.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'fashionhub' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Use a leading slash so generated static URLs are absolute (e.g. /static/style.css)
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'fashionhub' / 'static',
]
